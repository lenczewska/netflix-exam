    ...
    <div className="hover-card-latest absolute z-9990 bg-[#111] text-[#fff] w-[330px] h-[380px] p-[9px] top-[500px]  -translate-x-1/2 shadow-2xl transition-all duration-300">
      {data.backdrop_path && (
        <img
          ...
          className="rounded mb-2 hover-card-latest-img"
          alt={data.title || data.name}
        />
      )}
      <h3 className="text-xl font-bold mb-1 line-clamp-1  hover-card-latest-title">
        {data.title || data.name}
      </h3>
      <p className="text-sm mb-2 hover-card-latest-desc">
        {releaseYear} |
