    ...
    <>
      ...
      <div className="bg-[#1b1919ad] w-full h-screen absolute top-[0px]   ">
        <div className=" w-max inset-0  absolute top-[20px] right-[180px] flex justify-center items-center z-150">
          <div className="modal-box relative max-w-[1200px] w-[90%] bg-[#181818] rounded-[10px] p-[20px]">
            <button
              onClick={onClose}
              className="absolute cursor-pointer top-[15px] right-[15px] text-white text-[22px] bg-[#000] rounded-[50%] px-[5px] py-[3px]  "
            >
            ...
            <div className="flex flex-col ">
              ...
              <div className="inf-box mt-[40px]">
                <h2 className="text-[25px] font-[500] mb-[10px] text-white">
                  About <span className="text-[#fff]">{game?.title}</span>
                </h2>
                <p className="mb-[5px] text-[14px] text-[#a3a3a3]">
                  Category:{" "}
                  <span className="text-[#fff]">{game?.category}</span>
                </p>
                <p className="mb-[5px] text-[14px] text-[#a3a3a3]">
                  Modes: <span className="text-[#fff]">{game?.modes}</span>
                </p>
                ...
                <p className="mb-[5px] text-[14px] text-[#a3a3a3]">
                  Developer:{" "}
                  <span className="text-[#fff]">{game?.developer}</span>
                </p>
                <p className="mb-[5px] text-[14px] text-[#a3a3a3]">
                  Release Year:{" "}
