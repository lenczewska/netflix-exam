    ...
    <div className="hover-card-original absolute z-9990 bg-[#111] text-[#fff] w-[330px] h-[380px] p-[9px] top-[500px] -translate-x-1/2 shadow-2xl transition-all duration-300">
      {data.backdrop_path && (
        <img
          ...
          className="rounded mb-2 hover-card-original-img"
          alt={data.title || data.name}
        />
      )}
      <h3 className="text-xl font-bold mb-1 line-clamp-1 hover-card-original-title">
        {data.title || data.name}
      </h3>
      <p className="text-sm mb-2 hover-card-original-desc">
        {releaseYear} |{" "}
