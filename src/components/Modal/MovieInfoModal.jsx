...
import { faTimes, faPlus, faThumbsUp } from "@fortawesome/free-solid-svg-icons";
import logo_header from "../../assets/img/logo_header.png";
import { Link } from "react-router-dom";
import play_icon from "../../assets/img/play_icon.png";
import "./MovieInfoModal.css";

const MovieInfoModal = ({ show, movie, onClose, onAdd, onLike }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className="modal-scroll flex justify-center items-center max-h-[90vh] overflow-y-auto overflow-x-hidden"
          style={{ zIndex: 10001 }}
        >
