...
const MovieCards = ({
 ...
 useEffect(() => {
  ...
  return (
    <div className="title-cards  mt-[40px] relative">
      <h2 className=" title mb-[8px]">{title || "Popular on Netflix"}</h2>
      <div className="wrapper">
        {scrolled && (
          <button
            className="scroll-btn left-[0px] mr-[50px] absolute top-[180px] z-20 bg-[#000000c7] bg-opacity-60 text-white w-[50px] h-[142px] flex items-center justify-center"
        ...
        <button
          className="scroll-btn right-[-0px] absolute top-[180px] z-20 bg-[#000000c7] bg-opacity-60 text-white w-[50px] h-[142px] flex items-center justify-center"
          style={{ transform: "translateY(-50%)" }}
