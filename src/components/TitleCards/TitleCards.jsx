  ...
  return (
    <div className="title-cards pr-[50px] mt-[40px] relative">
      ...
      <div className="wrapper">
        {scrolled && (
          <button
            className="scroll-btn left-[0px] mr-[50px] absolute top-[220px] z-20 bg-[#000000c7] bg-opacity-60 text-white w-[50px] h-[145px] flex items-center justify-center"
        ...
        <button
          className="scroll-btn right-[-0px] absolute top-[220px] z-20 bg-[#000000c7] bg-opacity-60 text-white w-[50px] h-[145px] flex items-center justify-center"
          style={{ transform: "translateY(-50%)" }}
